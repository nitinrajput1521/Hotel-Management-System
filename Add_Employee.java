...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee()
    {
        ...
        String str[] = {"SELECT","Front desk clerks","Poretes","HouseKeeping","KitchenStaff","RoomService","Manager","Waiter/Waiteress","chefs"};
        ...
        lblsalary.setBounds(60,225,120,30);
        lblsalary.setFont(new Font("Tahoma",Font.PLAIN,17));
        add(lblsalary);
        
        tfsalary = new JTextField();
        tfsalary.setBounds(200,225,150,30);
        add(tfsalary);
